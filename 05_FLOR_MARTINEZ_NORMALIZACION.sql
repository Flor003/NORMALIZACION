...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-05-2021 a las 01:16:51
...
(2, 'Colonia Los Jasmines'),
(3, 'Barrio La Joya'),
(4, 'Barrio La Independencia'),
(5, 'Colonia Brisas de Altamira');
...
(1, 'Almuerzo con 2 refrescos', '2021-05-19', 2),
(2, '2 desayunos, 1 almuerzo', '2021-05-05', 4);
...
(1, 'Almuerzo', '2021-05-07', 3),
(2, '2 desayunos', '2021-05-10', 5);
...
(1, 'Arroz', '2021-05-18', 1),
(2, 'Frijoles', '2021-05-10', 5);
...
--
ALTER TABLE `tbl_envios`
  ADD CONSTRAINT `FK_DIRECCIONES_ENVIO` FOREIGN KEY (`ID_DIRECCION`) REFERENCES `tbl_direcciones` (`ID_DIRECCION`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `tbl_facturas`
--
ALTER TABLE `tbl_facturas`
  ADD CONSTRAINT `FK_DIRECCIONES_FACTURAS` FOREIGN KEY (`ID_DIRECCION`) REFERENCES `tbl_direcciones` (`ID_DIRECCION`);
